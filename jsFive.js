...
function fallCheck() {
  if (
    (pltfrm === true && jumpPermission === true) ||
    (pltfrm === false && jumpPermission === true)
  ) {
    jumpCheck();
  }
...
function checkX() {
  ...
  for (let i = 0; arrArr[levelInvert].length > i; i++) {
    ...
    if (i % 2 === 0) {
      ...
      if (
        (purpleX + al > arrArr[levelInvert][i] && purpleX < arrArr[levelInvert][i + 1]) ||
        (purpleX + al > arrArr[levelInvert][i] && arrArr[levelInvert][i + 1] == undefined)
      ) {
        pltfrm = true;
    ...
    if (i % 2 !== 0) {
      ...
      //    console.log("i % 2 !== 0 , i : ", i);
      if (
        (purpleX + ala > arrArr[levelInvert][i] && purpleX + ala < arrArr[levelInvert][i + 1]) ||
        (purpleX + ala > arrArr[levelInvert][i] && arrArr[levelInvert][i + 1] == undefined)
      ) {
        pltfrm = false;
        //console.log('pltfrm = false');
      }
